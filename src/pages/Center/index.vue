      ...
      <div class="order-body">
        ...
        <div class="order-right">
          <div class="order-content">
            ...
            <div class="orders">
              <!-- 单个订单 -->
              <table class="order-item" v-for="order in userOrderInfo.records" :key="order.id">
                <thead>
                  <tr>
                    <th colspan="5">
                ...
                <tbody v-for="orderDetail in order.orderDetailList" :key="orderDetail.id">
                  <tr>
                    <td width="60%">
...
<script>
import {reqUserOrderInfo} from '@/api'
  export default {
    name: 'Center',
    data(){
      return{
    ...
    methods:{
      async getUserOrderInfo(){
        ...
        let result =  await reqUserOrderInfo(page, limit)
        // console.log(result)
        if(result.code === 200){
          this.$message.success('获取我的订单成功！')
          this.userOrderInfo = result.data
        }else{
